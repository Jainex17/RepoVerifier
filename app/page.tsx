...
export default function Home() {
  ...
  return (
    ...
    <svg aria-hidden="true" className="my-20 w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <span className="sr-only">Loading...</span>
        ...
        {analysis && (
          <div className="mt-10">
            ...
            <h1 className="text-2xl font-bold my-5">Smilar Repository</h1>

            {analysis.results && (
              <div className="gap-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 my-5">
                {analysis.results.map((result, idx) => (
                  <div className="border-2 border-gray-500 p-5 rounded-md" key={idx}>
                    <p>Commit: {result.commit}</p>
                    <a href={result.repoLink} className="text-blue-500" target="_blank">
                      Repository Link
                    </a>
                  </div>
                ))}
